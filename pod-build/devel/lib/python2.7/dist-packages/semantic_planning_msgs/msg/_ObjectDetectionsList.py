...
"""autogenerated by genpy from semantic_planning_msgs/ObjectDetectionsList.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct

import semantic_planning_msgs.msg
import geometry_msgs.msg
import std_msgs.msg

class ObjectDetectionsList(genpy.Message):
  _md5sum = "969113d838edbc397dd4821909723f8f"
  _type = "semantic_planning_msgs/ObjectDetectionsList"
...
"""
  ...
  _slot_types = ['std_msgs/Header','semantic_planning_msgs/ObjectDetection[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ObjectDetectionsList, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      for val1 in self.objects:
        ...
        _x = val1
        buff.write(_get_struct_2B().pack(_x.has_orientation, _x.class_))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = semantic_planning_msgs.msg.ObjectDetection()
        _v5 = val1.header
        start = end
        end += 4
        ...
        (_x.has_orientation, _x.class_,) = _get_struct_2B().unpack(str[start:end])
        val1.has_orientation = bool(val1.has_orientation)
